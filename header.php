...
<head>
  ...
  <title><?php echo $title;?> - <?php echo $tools_settings['description'];?></title>
  ...
  <meta name="Author" Content="胡家小子,admin@boyhu.cn">
  <meta name="Copyright" Content="本页版权归胡家小子所有.All Rights Reserved">
