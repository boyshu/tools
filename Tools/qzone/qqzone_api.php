...
if(getParam('qq')){
  ...
  if( ($TxtRes=fopen ($TxtFileName,"w+")) === FALSE){
	...
	$referer = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : 'http://tools.yum6.cn/Tools/qzone/';
  $StrConents = '
<html lang="zh-CN">
<head>
	...
	<body>
    <center><button style="padding:10px 20px 10px 20px;border:10px;color:blue;"><a href="'.$referer.'">我也要制作</a></button></center>
