...
<div class="container clearfix">
			...
			<div id="content" class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
				<form class="am-form" id="shorturl">
					<div class="am-form-group am-g-collapse">
						<div class="am-u-sm-8">
							<input type="text" name="alipay_url" id="alipay_url" placeholder="支付宝收款码地址">
						</div>
						<div class="am-form-group am-form-file">
							<button type="button" class="am-btn am-btn-danger am-btn-sm"><i class="am-icon-cloud-upload"></i> 上传</button>
							<input id="alipay_url" type="file" accept="image/*">
						</div>
					</div>
					<div class="am-form-group am-g-collapse">
						<div class="am-u-sm-8">
							<input type="text" name="wechat_url" id="wechat_url" value="" placeholder="微信收款码地址">
						</div>
						<div class="am-form-group am-form-file">
							<button type="button" class="am-btn am-btn-danger am-btn-sm"><i class="am-icon-cloud-upload"></i> 上传</button> <input id="wechat_url" type="file" accept="image/*">
						</div>
					</div>
					<div class="am-form-group am-g-collapse">
						<div class="am-u-sm-8">
							<input type="text" name="qq_url" id="qq_url" value="" placeholder="QQ收款码地址">
						</div>
						<div class="am-form-group am-form-file">
							<button type="button" class="am-btn am-btn-danger am-btn-sm"><i class="am-icon-cloud-upload"></i> 上传</button> <input id="qq_url" type="file" accept="image/*">
						</div>
					</div>           
					<br>
					<div class="am-cf">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<p>一个在线生成支持QQ、支付宝、微信三合一收款码的小工具：</p>
			<p>1.手机上保存三个平台的收款码图片后，在本工具中上传图片自动识别收款码地址</p>
			<p>2.点击生成之后就可以得到一张能识别三个平台收款码的图片</p>
			<p>3.最后保存图片即可使用</p>
		</div>
	</div>
</div>
