...
<footer class="footer text-center">
	<div>
    <!--切勿商用,切勿改版权,后果自付-->
   <a target="_blank" href="<?php echo Tools_url;?>/about.php" >关于我们</a> - <a rel="nofollow" href="http://tools.boyhu.cn">工具首页</a> - <a href="<?php echo Tools_url;?>/log.php" target="_blank">运营历程</a>
            <br>
